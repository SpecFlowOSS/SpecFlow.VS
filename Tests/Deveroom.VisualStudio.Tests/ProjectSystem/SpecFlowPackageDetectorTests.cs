...
namespace Deveroom.VisualStudio.Tests.ProjectSystem
{
    public class SpecFlowPackageDetectorTests
    {
        ...
        private const string SpecSyncPackagePathSolutionPackages = @"C:\MyProject\packages\SpecSync.AzureDevOps.SpecFlow.2-4.2.0.0";
        ...
        {
            return new SpecFlowPackageDetector(_mockFileSystem);
        }
        ...
        [Fact]
        public void GetSpecFlowPackage_finds_SpecFlow_package_when_listed_even_if_other_specflow_related_packages_are_listed_before()
        {
            var sut = CreateSut();
        ...
        [Fact]
        public void GetSpecFlowPackage_finds_SpecFlow_package_within_solution_when_only_SpecFlow_extension_packages_are_listed()
        {
