    ...
    */
    public class ProjectBindingRegistryMultiMatchTests : ProjectBindingRegistryTestsBase
    {
        ...
        public void Removes_duplicated_stepdefs_in_SO()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my <what> step"), CreateScenarioOutlineContext(null, null, "what", new []{ "cool", "other", "colorful" } ));
            result.HasMultipleMatches.Should().BeTrue();
        ...
        public void Includes_tagged_examples_in_scope_matching_in_SO()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my <what> step"),
                CreateScenarioOutlineContext(null, null, "what", new[] { "scoped", "other" }, outlineExamplesTags: new[] { "@mytag" }));
            result.HasMultipleMatches.Should().BeTrue();
            result.Items.All(r => r.Type == MatchResultType.Defined).Should().BeTrue();
        }
        ...
        public void Includes_tagged_examples_in_scope_matching_for_Background()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my step"), CreateBackgroundContext(outlineExamplesTags: new [] {"@mytag"}));
            result.HasMultipleMatches.Should().BeTrue();
            result.Items.All(r => r.Type == MatchResultType.Defined).Should().BeTrue();
        }
        ...
        public void Includes_invalid_match_in_result_in_SO()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my <what> step"), CreateScenarioOutlineContext(null, null, "what", new[] { "cool", "invalid 50 with extras" }));
            result.HasMultipleMatches.Should().BeTrue();
            result.Items.All(r => r.Type == MatchResultType.Defined).Should().BeTrue();
        ...
        public void Includes_max_1_undefined_in_result_in_SO()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my <what> step"), CreateScenarioOutlineContext(null, null, "what", new[] { "cool", "other", "third" }));
            result.HasMultipleMatches.Should().BeTrue();
            result.Items.Should().HaveCount(2);
            result.Items.Should().Contain(m => m.Type == MatchResultType.Undefined);
        }
        ...
        public void Includes_max_1_ambiguous_with_all_candidates_in_result_in_SO()
        {
            ...
            var result = sut.MatchStep(CreateStep(text: "my <what> step"), CreateScenarioOutlineContext(null, null, "what", new[] { "cool", "other", "organic" }));
            result.HasMultipleMatches.Should().BeTrue();
