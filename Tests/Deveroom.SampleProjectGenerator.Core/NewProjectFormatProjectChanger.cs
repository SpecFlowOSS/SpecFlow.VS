...
namespace Deveroom.SampleProjectGenerator
{
    ...
    {
        public NewProjectFormatProjectChanger(string projectFilePath, string targetPlatform = null) : base(projectFilePath, targetPlatform)
        {
