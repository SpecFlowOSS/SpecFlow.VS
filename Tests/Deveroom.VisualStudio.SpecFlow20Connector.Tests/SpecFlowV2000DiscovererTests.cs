...
{
    public class SpecFlowV2000DiscovererTests
    {
        private SpecFlowV2000Discoverer CreateSut()
        {
            var stubDiscoverer = new SpecFlowV2000Discoverer();
        ...
        private DiscoveryResult PerformDiscover(SpecFlowV2000Discoverer sut)
        {
