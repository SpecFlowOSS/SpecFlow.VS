...
public class RenameStepCommand : DeveroomEditorCommandBase, IDeveroomCodeEditorCommand, IDeveroomFeatureEditorCommand
{
    ...
    private List<(IProjectScope specFlowTestProject, ProjectStepDefinitionBinding projectStepDefinitionBinding)>
    ...
    private void PerformActions(
        IReadOnlyList<(IProjectScope specFlowTestProject, ProjectStepDefinitionBinding projectStepDefinitionBinding)>
            ...
            default:
            {
                ...
                IdeScope.Actions.ShowSyncContextMenu(ChooseStepDefinitionPopupHeader, stepDefinitions.Select(sd =>
                    new ContextMenuItem(sd.projectStepDefinitionBinding.ToString(),
                        _ =>
                        {
                            PerformActionsOnSelectedStepDefinition(sd.specFlowTestProject,
