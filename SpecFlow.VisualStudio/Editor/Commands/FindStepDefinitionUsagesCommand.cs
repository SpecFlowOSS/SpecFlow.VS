...
public class FindStepDefinitionUsagesCommand : DeveroomEditorCommandBase, IDeveroomCodeEditorCommand
{
    ...
    public override DeveroomEditorCommandTargetKey[] Targets => new[]
    {
        new DeveroomEditorCommandTargetKey(SpecFlowVsCommands.DefaultCommandSet,
            SpecFlowVsCommands.FindStepDefinitionUsagesCommandId)
    };
        ...
        IntPtr inArgs = default)
    {
        ...
        Task.Run(
            () => FindUsagesInProjectsAsync(specFlowTestProjects, fileName, triggerPoint, asyncContextMenu,
                asyncContextMenu.CancellationToken), asyncContextMenu.CancellationToken);
        return true;
    }

    private async Task FindUsagesInProjectsAsync(IProjectScope[] specFlowTestProjects, string fileName,
    ...
    private async Task FindUsagesInternalAsync(IProjectScope[] specFlowTestProjects, string fileName,
        SnapshotPoint triggerPoint, IAsyncContextMenu asyncContextMenu, CancellationToken cancellationToken,
