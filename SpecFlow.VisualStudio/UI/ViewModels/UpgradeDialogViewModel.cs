...
";
        ...
        public MarkDownWizardPageViewModel OtherNewsPage => Pages.OfType<MarkDownWizardPageViewModel>().FirstOrDefault(p => p.Name == "Community");
...
#if DEBUG
        public static UpgradeDialogViewModel DesignData = new UpgradeDialogViewModel("1.0.99", @"# v1.0.1 - 2019-02-27
