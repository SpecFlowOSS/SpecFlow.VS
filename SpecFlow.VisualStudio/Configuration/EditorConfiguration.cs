...
namespace SpecFlow.VisualStudio.Configuration
{
    public class EditorConfiguration
    {
        ...
        {
            return ShowStepCompletionAfterStepKeywords == other.ShowStepCompletionAfterStepKeywords && Equals(GherkinFormat, other.GherkinFormat);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (ShowStepCompletionAfterStepKeywords.GetHashCode() * 397) ^ (GherkinFormat != null ? GherkinFormat.GetHashCode() : 0);
            }
        }
