...
{
    public class RuntimeBindingRegistryBuilderV301062Patch : IRuntimeBindingRegistryBuilder
    {
        #region Original SpecFlow code from V3.0.62
        private readonly IRuntimeBindingSourceProcessor bindingSourceProcessor;

        public RuntimeBindingRegistryBuilderV301062Patch(IRuntimeBindingSourceProcessor bindingSourceProcessor)
        {
        ...
        private BindingSourceType CreateBindingSourceType(Type type, IEnumerable<Attribute> filteredAttributes)
        {
            return new BindingSourceType
            {
                ...
                #endregion Original SpecFlow code from V3.0.62
                #region patch
