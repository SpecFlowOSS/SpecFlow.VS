...
namespace SpecFlow.VisualStudio.UI
{
    partial class DeveroomResources
    {
        ...
        private void OverwriteVsStyles()
        {
            ...
            SetThemedBrushFromColorKey(ThemedDialogColors.CloseWindowButtonHoverColorKey, "ThemedCloseWindowButtonHoverBrushKey");
            SetThemedBrushFromColorKey(ThemedDialogColors.CloseWindowButtonHoverTextColorKey, "ThemedCloseWindowButtonHoverTextBrushKey");
        ...
        private bool IsRunningFromVs()
        {
            return "devenv".Equals(Process.GetCurrentProcess().ProcessName, StringComparison.InvariantCultureIgnoreCase);
        }
    }
}
