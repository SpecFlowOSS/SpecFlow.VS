...
using System.Text;
using Deveroom.VisualStudio.Generator.Infrastructure;
...
namespace Deveroom.VisualStudio.Generator
{
    ...
    [CodeGeneratorRegistration(typeof(DeveroomSingleFileGenerator), Description, vsContextGuids.vsContextGuidVCSProject, GeneratesDesignTimeSource = true, GeneratorRegKeyName = Name)]
    [CodeGeneratorRegistration(typeof(DeveroomSingleFileGenerator), Description, vsContextGuids.vsContextGuidVBProject, GeneratesDesignTimeSource = true, GeneratorRegKeyName = Name)]
    ...
    public class DeveroomSingleFileGenerator : BaseCodeGeneratorWithSite
    {
        ...
        {
            return ".feature" + base.GetDefaultExtension();
        }
